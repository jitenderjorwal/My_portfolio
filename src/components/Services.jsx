...
const Services = () => {
  return (
    ...
    <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">Hi, I'm Jitender, an MCA graduate with a passion for front-end development. I'm skilled in HTML, CSS, JavaScript, and ReactJS, and eager to apply my knowledge to create engaging web applications as I begin my career.</p>
