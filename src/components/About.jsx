  ...
  return (
    ...
    <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
            <p className="mb-10 max-w-2xl font-Ovo">Hi, I'm Jitender, an MCA graduate with a passion for front-end development. I'm skilled in HTML, CSS, JavaScript, and ReactJS, and eager to apply my knowledge to create engaging web applications as I begin my career.This version is brief and to the point, while still highlighting your key strengths.</p>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
                ...
                ">
                    ...
                    <p className="text-gray-600 text-sm dark:text-white/80">HTML, CSS, JavaScript, React Js, Express Js </p>
                </li>
                <li className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50">
                    ...
                    <p className="text-gray-600 text-sm dark:text-white/80">Master of Computer Science(MCA) </p>
                </li>
                <li className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50">
                    ...
                    <p className="text-gray-600 text-sm dark:text-white/80">Built more than 3 projects </p>
                </li>
            </ul>
