...
const Header = () => {
  return (
    ...
    <h3 className="flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo">
        Hi! I'm Jitender <img src="./assets/hand-icon.png" alt="" className="w-6"/></h3>
    <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">frontend web developer based in India.</h1>
    <p className="max-w-2xl mx-auto font-Ovo">I am a frontend developer from Dehli, INDIA.</p>
    ...
    <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
        ...
        <a href="https://drive.google.com/file/d/1lv_LhEbGH-ZVvxfXg2zD7HknCLfTAHEc/view?usp=drivesdk" download
